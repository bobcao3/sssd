...
struct dp_option default_idp_opts[] = {
    ...
    { "idp_private_key_file", DP_OPT_STRING, NULL_STRING, NULL_STRING },
    { "idp_private_key_kid", DP_OPT_STRING, NULL_STRING, NULL_STRING },
    ...
    { "idp_auth_client_id", DP_OPT_STRING, NULL_STRING, NULL_STRING },
    { "idp_auth_client_secret", DP_OPT_STRING, NULL_STRING, NULL_STRING },
